    ...
    it('returns a resolved promise with registration data when successful', () => {
      ...
      return client.register(payload).then((data) => {
        ...
        chai
          ...
          .to.be.equal('http://127.0.0.1:8080/v1/register');
    ...
    it('returns a rejected promise when an error occurs', () => {
      ...
      return client
        ...
        .catch((err) => {
          ...
          chai
            .expect(err.message)
            .to.be.equal('An error occurred while registering a new account.');
        });
    });
  });
  ...
  describe('updateUser', () => {
    it('returns a resolved promise with update data when successful', () => {
      ...
      return client.updateUser(payload).then((data) => {
        ...
        chai
          .expect(getCalls[0].args[0])
          .to.be.equal('http://127.0.0.1:8080/v1/updateUser');
    ...
    it('returns a rejected promise when an error occurs', () => {
      ...
      return client
        ...
        .catch((err) => {
          ...
          chai
            .expect(err.message)
            .to.be.equal('An error occurred while updating the user.');
        });
    });
  });
  ...
  describe('getPublicSignature', () => {
    it('returns a resolved promise with signature data when successful', () => {
      ...
      return client.getPublicSignature().then((data) => {
        ...
        chai
          .expect(getCalls[0].args[0])
          .to.be.equal('http://127.0.0.1:8080/v1/publicSignature');
    ...
    it('returns a resolved promise with signature data when successful', () => {
      ...
      return client.impersonateUser(payload).then((data) => {
        ...
        chai
          ...
          .to.be.equal('http://127.0.0.1:8080/v1/impersonate');
